...
const Profile = () => {
  ...
  const handleSave = async () => {
    ...
    const validation = profileSchema.safeParse({ fullName, department, phone });
        ...
        <Card className="p-6 card-industrial mb-6">
          <div className="flex flex-col items-center mb-6">
            <div className="relative">
              ...
              <button
                type="button"
                className="absolute bottom-0 right-0 bg-primary rounded-full p-2 border-2 border-card"
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input id="empId" value={employeeId} disabled />
            </div>
            <div>
